...
import { sendChatMessage, checkHealth, type ChatMessage, type ChatResponse } from "./chatbot-api";
import "./chatbot.css";
...
const ChatBot: React.FC<ChatBotProps> = ({ userId = "anonymous", portalName = "PE/VC Portal" }) => {
